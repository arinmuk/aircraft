...
function inittwo(){
        ...
        //console.log(yr2019)
        var trace={x:yr20202.map(row=>row.month),
                y:yr20202.map(row=>row.NetRecd),
                name:"2020",
                 type:"scatter"
      }
        var trace1={x:yr20192.map(row=>row.month),
                   y:yr20192.map(row=>row.NetRecd),
                   name:"2019",
                    type:"bar"
         }
        var trace2={x:yr20182.map(row=>row.month),
                y:yr20182.map(row=>row.NetRecd),
                name:"2018",
                 type:"bar"
        }
        
         var trace3={x:yr20172.map(row=>row.month),
                y:yr20172.map(row=>row.NetRecd),
                name:"2017",
                 type:"bar"
                
         }
         var trace4={x:yr20162.map(row=>row.month),
                y:yr20162.map(row=>row.NetRecd),
                name:"2016",
                 type:"bar"
        }

         var trace5={x: yr20152.map(row=>row.month),
                     y: yr20152.map(row=>row.NetRecd),
                        name:"2015",
                         type:"bar"
        }
        var trace6={x: yr20142.map(row=>row.month),
                y: yr20142.map(row=>row.NetRecd),
                   name:"2014",
                    type:"bar"
   }
        var trace7={x: yr20132.map(row=>row.month),
                y: yr20132.map(row=>row.NetRecd),
                name:"2013",
                type:"bar"
}    
var trace8={x: yr20122.map(row=>row.month),
        y: yr20122.map(row=>row.NetRecd),
        name:"2012",
        type:"bar"
} 
var trace9={x: yr20112.map(row=>row.month),
