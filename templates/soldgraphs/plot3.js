...
function ainittwo(){
        ...
        //console.log(yr2019)
        var trace={x:ayr20192.map(row=>row.month),
        ...
        var trace1={x:ayr20182.map(row=>row.month),
         ...
         var trace2={x:ayr20172.map(row=>row.month),
         ...
         var trace3={x:ayr20162.map(row=>row.month),
         ...
         var trace4={x: ayr20152.map(row=>row.month),
        ...
        var trace5={x: ayr20142.map(row=>row.month),
        ...
        var trace6={x: ayr20132.map(row=>row.month),
...
var trace7={x: ayr20122.map(row=>row.month),
...
var trace8={x: ayr20112.map(row=>row.month),
...
// YOUR CODE HERE
var ayr20192 = data1.filter(ayear20192)
var ayr20182 = data1.filter(ayear20182)
var ayr20172 = data1.filter(ayear20172)
var ayr20162 = data1.filter(ayear20162)
var ayr20152 = data1.filter(ayear20152)
var ayr20142 = data1.filter(ayear20142)
var ayr20132 = data1.filter(ayear20132)
var ayr20122 = data1.filter(ayear20122)
var ayr20112 = data1.filter(ayear20112)
ainittwo()